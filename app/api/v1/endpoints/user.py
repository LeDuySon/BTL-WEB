...
from app.models.location import LocationFromCode
...
@router.get('/user/survey/location/citizens', tags=["User"])
...
@router.get('/user/survey/citizen-by-id-number', tags=["User"])
